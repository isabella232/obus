...
/**
 * @brief check @ref ps_summary_method_handlers structure is valid.
 *
...
/**
 * @brief check @ref ps_summary_set_refresh_rate_args structure is complete (all arguments are present).
 *
...
/**
 * @brief check @ref ps_summary_set_mode_args structure is complete (all arguments are present).
 *
...
/**
 * @brief initialize @ref ps_summary_info structure.
 *
 * This function initialize @ref ps_summary_info structure.
 * Each field has its presence bit cleared.
 *
 * @param[in]  info  pointer to allocated @ref ps_summary_info structure.
 **/
void ps_summary_info_init(struct ps_summary_info *info);

/**
 * @brief check @ref ps_summary_info structure contents is empty.
 *
 * This function check if each field has its presence bit cleared
 *
 * @param[in]  info  @ref ps_summary_info structure.
 *
...
/**
 * @brief set @ref ps_summary_info methods state.
 *
