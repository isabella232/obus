 ...
 * @ps_process_info structure must be taken into account.
 **/
...
/**
 * @brief initialize @ps_process_info structure.
 *
 * This function initialize @ps_process_info structure.
 * Each field has its presence bit cleared.
 *
 * @param[in]  info  pointer to allocated @ps_process_info structure.
 **/
void ps_process_info_init(struct ps_process_info *info);

/**
 * @brief check @ps_process_info structure contents is empty.
 *
 * This function check if each field has its presence bit cleared
 *
 * @param[in]  info  @ps_process_info structure.
 *
